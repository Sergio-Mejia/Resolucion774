        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form action="../Estacion/insertarE.php" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nombre" class="form-control dato1" required>
                            </div>
                            <div class="col-md-6">
                                <label for="">Dirección</label>
                                <input type="text" name="direccion" class="form-control dato1" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <h2 align="center">Coordenadas Geográficas</h2>
                    <div class="form-group">
                        <div class="row g-2">
                            <div class="col-md-6">
