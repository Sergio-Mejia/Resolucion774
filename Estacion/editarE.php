                    ...
                    <div class="form-group">
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="nombre" value="<?php echo $reg[0]['nombre'] ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="direccion" value="<?php echo $reg[0]['direccion'] ?>" required>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="number" name="altura" value="<?php echo $reg[0]['altura'] ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="number" step="any" name="latitud" value="<?php echo $reg[0]['latitud'] ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="">Longitud</label>
                                <input class="form-control" type="number" step="any" name="longitud" value="<?php echo $reg[0]['longitud'] ?>">
                            </div>
                        </div>
                    </div>

                    </br>
                    <button type="submit" class=" form-control btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Agregar servicio">Cambiar</button>
